  ...
  return (
    <div>
        <div className='flex items-center space-x-8 '>
            <div className='w-10 h-10 md:w-16 md:h-16 rounded-full bg-gradient-to-r from-emerald-500 to-emerald-900 flex 
        ...
        <div className='flex items-center space-x-8'>
            ...
            <div>
                ...
                <h1 className='text-base sm:text-lg text-white/70'>{contactData.address}</h1>
            </div>
        </div>
    </div>
  )
